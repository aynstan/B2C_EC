<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="B2C_EC.Website.Payment" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentMain" runat="server">
    <div class="TableDescription">
        <div class="titleh2">Payment your cart</div>
        <div class="Description">
            <div id="viewcart">
                <table align="center" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td style="width: 300px">
                            ...
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtFullName" runat="server" CssClass="TextBox" MaxLength="250"></asp:TextBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtPhone" runat="server" CssClass="TextBox" MaxLength="50"></asp:TextBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtEmail" runat="server" CssClass="TextBox" MaxLength="250"></asp:TextBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtStreet" runat="server" CssClass="TextBox" MaxLength="200"></asp:TextBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtCity" runat="server" CssClass="TextBox" MaxLength="100"></asp:TextBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtState" runat="server" CssClass="TextBox" MaxLength="100"></asp:TextBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtCountry" runat="server" CssClass="TextBox" MaxLength="100"></asp:TextBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtZipCode" runat="server" CssClass="TextBox" MaxLength="50"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td>Notes</td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtNotes" runat="server" CssClass="TextBox" Height="80px" Rows="3" TextMode="MultiLine" MaxLength="350"></asp:TextBox></td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            ...
                            <asp:TabContainer ID="tabContainer" runat="server" ActiveTabIndex="0" Width="96%">
                                <asp:TabPanel runat="server" HeaderText="Online Payment" ID="TabPaneOnlinePayment">
                                    <ContentTemplate>
                                        ...
                                        <div style="text-align: center; margin-top: 15px">
                                            <asp:Button ID="btnOrderPaymentOnline" runat="server" Text="Order Now" CssClass="Button" OnClick="btnOrder_Click" OnClientClick="return Validate();" /></div>
                                    </ContentTemplate>
                                </asp:TabPanel>
                                <asp:TabPanel runat="server" HeaderText="Delivery" ID="TabPanelDelivery">
                                    <ContentTemplate>
                                        ...
                                        <br />
                                        <div style="text-align: center; margin-top: 15px">
                                            <asp:Button ID="btnOrderDelivery" runat="server" Text="Order Now" CssClass="Button" OnClick="btnOrder_Click" ValidationGroup="recipient" /></div>
                                    </ContentTemplate>
                                </asp:TabPanel>
                                <asp:TabPanel runat="server" HeaderText="Office" ID="TabPanelOffice">
                                    <ContentTemplate>
                                        ...
                                        <br />
                                        <div style="text-align: center; margin-top: 15px">
                                            <asp:Button ID="btnOrderOffice" runat="server" Text="Order Now" CssClass="Button" OnClick="btnOrder_Click" ValidationGroup="recipient" /></div>
                                    </ContentTemplate>
                                </asp:TabPanel>
                            </asp:TabContainer>
                        </td>
                    ...
                    <tr>
                        <td align="right" colspan="2" style="height: 43px; color: #333; font-weight: bold" valign="top">Subtotal (<asp:Label ID="lbTotalQuantity" runat="server" Text="5"></asp:Label>
                            &nbsp;items):
                            <asp:Label ID="lbTotalPrice" runat="server" Text="$2,162.63" ForeColor="#B12704"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
