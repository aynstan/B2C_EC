<%@ Page Title="" Language="C#" MasterPageFile="~/Admincp/Site.master" AutoEventWireup="true" CodeBehind="Management-ShoppingCart.aspx.cs" Inherits="HoangQuanMobile.Website.Admincp.Management_ShoppingCart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Trang Quản Lý Đặt Hàng - Thanh Toán</h1>
            ...
            <asp:MultiView ID="MutiView1" ActiveViewIndex="0" runat="server">
                <asp:View ID="View1" runat="server">
                    <div class="manager">
                        ...
                        <br />
                        <br />
                        <asp:GridView ID="gvOrders" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="947px" OnSelectedIndexChanging="gvOrders_SelectedIndexChanging" AllowPaging="True" OnPageIndexChanging="gvOrders_PageIndexChanging" DataKeyNames="CartId" OnRowDataBound="gvOrders_RowDataBound" >
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:Panel ID="pnlShippingCartDetail" runat="server" Style="text-align:center; display: none">
                                            <asp:GridView ID="gvShippingCartDetail" runat="server" AutoGenerateColumns="false" CssClass="ChildGrid">
                                                <Columns>
                                                    <asp:BoundField ItemStyle-Width="150px" DataField="CartDetailId" HeaderText="Mã CTDH" />
                                                    <asp:BoundField ItemStyle-Width="150px" DataField="CartId" HeaderText="Mã ĐH" />
                                                    ...
                                                    <asp:BoundField ItemStyle-Width="150px" DataField="TotalMoney" HeaderText="Thành tiền" />
                                                </Columns>
                                            </asp:GridView>
                                        </asp:Panel>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="Mã" DataField="CartId" />
                                ...
                                <asp:TemplateField HeaderText="Trạng Thái">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("IsAccept") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# ((Eval("IsAccept").ToString()=="True")?"Đã duyệt":"Chưa duyệt") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
